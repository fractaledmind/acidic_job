...
class ActiveJobTestCases < ActiveSupport::TestCase
  ...
  class SerializingTest < ActiveJobTestCases
    ...
    # {"job_class"=>"ActiveJobTestCases::SerializingTest::SerializableWorker", "job_id"=>"1e84f61e-1725-43b3-9a23-a358b9646e52", "provider_job_id"=>nil, "queue_name"=>"some_queue", "priority"=>50, "arguments"=>[], "executions"=>0, "exception_executions"=>{}, "locale"=>"en", "timezone"=>"UTC", "enqueued_at"=>"2022-08-07T17:47:24Z"}
